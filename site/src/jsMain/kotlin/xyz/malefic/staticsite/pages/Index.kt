...
import xyz.malefic.staticsite.components.BarChart
import xyz.malefic.staticsite.components.DataTable
import xyz.malefic.staticsite.components.PieChart
...
private fun GibbonImages() {
    SectionBox("Study Subjects - Lar Gibbons at Metro Zoo") {
        Div(
            attrs =
                Modifier
                    .fillMaxWidth()
...
private fun Results() {
    SectionBox("Key Results") {
        Ul(attrs = {
            ...
            Li {
                Text(
                    "Morning vocalization peak: 68% of all calls occurred between 6-10 AM, coinciding with natural dawn chorus behavior",
                )
            }
            Li { Text("Great calls and duets comprised 60% of total vocalizations, indicating strong pair bonding") }
            Li {
                Text(
                    "Significant increase in calling frequency during spring months (March-April), potentially related to breeding season",
                )
            }
...
private fun Analysis() {
    SectionBox("Analysis & Discussion") {
        P(attrs = {
            style {
                fontSize(16.px)
                property("line-height", "1.6")
        ...
        P(attrs = {
            ...
            Text(
                "The gradual increase in juvenile participation demonstrates active vocal learning, a critical aspect of gibbon development. ",
            )
            Text(
...
private fun Conclusion() {
    SectionBox("Conclusion") {
        ...
        P(attrs = {
            ...
            B { Text("Implications: ") }
            Text(
                "These findings support the use of vocal behavior as a non-invasive welfare assessment tool in captive gibbon populations. ",
            )
            Text(
        ...
        H2(
            attrs = {
                style {
                    ...
                    color(Color("#2c3e50"))
                    marginBottom(20.px)
                    property("border-bottom", "3px solid #3498db")
                    paddingBottom(10.px)
                }
            },
        ) {
